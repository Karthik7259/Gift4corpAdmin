  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="text-lg text-white">Loading order details...</p>
      </div>
    )
  }
    ...
    <div className="max-w-5xl mx-auto space-y-5">
      ...
      <div className="section-card glass-card">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-3 text-white">Shipping Address</h3>
            <div className="space-y-1 text-sm text-gray-200">
              ...
              <p className="mt-2">
                <span className="font-medium text-white">Phone:</span> {order.address.phone}
              </p>
              {order.address.email && (
                <p>
                  <span className="font-medium text-white">Email:</span> {order.address.email}
                </p>
              )}
            </div>
          </div>
      ...
      <div className="section-card glass-card">
        <h3 className="text-lg font-semibold mb-4 text-white">Price Breakdown</h3>
